...
# sd + opt
# CUDA_VISIBLE_DEVICES=3 python -m scripts.motionctrl_animate \
...
# sd + sparse + 512
# CUDA_VISIBLE_DEVICES=2 python -m scripts.motionctrl_animate \
...
# cmcm + sparse + 512
CUDA_VISIBLE_DEVICES=3 python -m scripts.motionctrl_animate \
    --config configs/prompts/motionctrl/v3-1-sd_cmcm_omcm_sparse_512.yaml \
    --H 512 \
    --W 512